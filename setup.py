...
setup(name='docassemble.ALToolbox',
      ...
      url='https://assemblyline.suffolklitlab.org/docs/components/ALToolbox/overview',
      packages=find_namespace_packages(),
      install_requires=['holidays>=0.38', 'pandas>=2.0.3', 'tiktoken>=0.8.0', 'openai>=1.99.1', 'markitdown[all]>=0.1.3'],
      zip_safe=False,
