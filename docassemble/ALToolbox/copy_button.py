...
def copy_button_html (
  ...
  if copy_template_block:
    button_str += f'<textarea readonly class=" card card-body{style_class} bg-light pb-1 al_copy_value {scroll_class}" placeholder="inert help text here" {adjust_height}>{ text_to_copy }"</textarea>\n'
  ...
  if copy_template_block:
    ...
    button_str += f'<button class="btn btn-secondary al_copy_button" type="button">\n'
